...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and competitive matches for soccer enthusiasts",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice dribbling, shooting, and teamwork on the court",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, build performance skills, and put on plays",
    ...
    "Debate Team": {
        "description": "Practice argumentation and public speaking in competitive debates",
